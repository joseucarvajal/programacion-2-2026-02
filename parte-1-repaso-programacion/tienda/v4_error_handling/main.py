...
while quiere_seguir_llevando_productos == True: # B-10. Usualmente, el cliente comprador de productos en el supermercado no sabe cuántos productos lleva en su canasto/carrito de compras 
    ...
    nombre_del_producto = ""
    while nombre_del_producto == "": # B-10. Cuando hay un error, el programa se cierra intempestivamente. Debería volver a preguntar el valor que se ingresó mal y dejar continuar al usuario ingresando datos
        ...
        el_precio_del_producto_es_valido = False # B-10. Cuando hay un error, el programa se cierra intempestivamente. Debería volver a preguntar el valor que se ingresó mal y dejar continuar al usuario ingresando datos
        while el_precio_del_producto_es_valido == False: 
            ...
            if precio_del_producto == "":
                ...
                try: # B-3. El precio acepta caracteres no numéricos
                    precio_del_producto = float(precio_del_producto)
                except:
                    print("ERROR: El precio sólo acepta valores numéricos")
                    continue
                ...
                if precio_del_producto < 0:
                    ...
                    el_precio_del_producto_es_valido = True
        ...
        if descuento_del_producto == "":
            ...
            try: # El descuento acepta caracteres no numéricos
                descuento_del_producto = float(descuento_del_producto) # Tipos de variables: decimal, es decir: float
            except:
                print("ERROR: El descuento sólo acepta valores numéricos")
